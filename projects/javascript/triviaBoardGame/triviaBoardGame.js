...
var mS = new state(function(){
  ...
  textSize(40);
  fill(255, 0, 0);
  text("Q", width / 2 - 100, 50);
  text("d", width / 2 + 80, 50);
  text("B", width / 2, 50);
  
  fill(0, 255, 0);
  text("u", width / 2 - 70, 50);
  text("o", width / 2 + 25, 50);
  
  fill(0, 0, 255);
  text("i", width / 2 - 50, 50);
  text("a", width / 2 + 45, 50);
  
  fill(255, 255, 0);
  text("z", width / 2 - 40, 50);
  text("r", width / 2 + 65, 50);
